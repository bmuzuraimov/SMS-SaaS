! function(t, e) {
    ...
    function xn(a, s, u) {
        return new Promise(function(t) {
            ...
            Ce.swalPromiseResolve.set(a, t), s.confirmButton.onclick = function() {
                ...
                capture: t.keydownListenerCapture
            }), t.keydownHandlerAdded = !0), (u.toast && (u.input || u.footer || u.showCloseButton) ? vt : bt)(document.body, $["toast-column"]), r = a, "select" === (t = u).input || "radio" === t.input ? tn(r, t) : -1 !== ["text", "email", "number", "tel", "textarea"].indexOf(t.input) && (b(t.inputValue) || w(t.inputValue)) && en(r, t), je(u), Pn(te, u, e), En(s, u), setTimeout(function() {
    ...
    }), jn.DismissReason = Q, jn.version = "10.15.5";
    var Mn = jn;
